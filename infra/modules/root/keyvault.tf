...
# Entra client secret is auto-generated by Terraform (azuread_application_password)
# and surfaced here via Key Vault so it never appears in state or inline env.
